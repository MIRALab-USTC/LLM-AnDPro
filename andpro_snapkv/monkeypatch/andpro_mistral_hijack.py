...
from andpro_snapkv.monkeypatch.snapkv_utils import init_andpro_snapkv, DynamicCacheSplitHeadFlatten
...
def andpro_MistralModel_forward(
    self,
...
def andpro_mistral_flash_attn2_forward(
    self,
